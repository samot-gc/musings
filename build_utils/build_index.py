...
def build_markdown(papers, output_file="README.md"):
    readme_lines = []
    readme_lines.append("A searchable, filterable, and sortable version of this index is available on the [GitHub page](https://samot-gc.github.io/summaries-with-sam/index.html).\n")
    readme_lines.append("\n")
    ...
    for paper in papers:
        ...
        github_url = f"https://github.com/samot-gc/summaries-with-sam/blob/main/papers/{md_filename}"
