...
The evaluation are all question–answer style, making them ideal for GRPO. Sparse rewards are used: $1$ for the correct final answer (regardless of the intermediate tokens) and $0$ otherwise. The GRPO implementation appears pretty standard; see my [RL Algorithms Overview](RL%20Algorithms-%20Overview.html) or summary of he [DeepSeekMath paper](DeepSeekMath%20GRPO.html) for general GRPO details.
